...
#  if EVDEV_CALIBRATE
#    define EVDEV_HOR_MIN      3900               /*to invert axis swap EVDEV_XXX_MIN by EVDEV_XXX_MAX*/
#    define EVDEV_HOR_MAX       200               /*"evtest" Linux tool can help to get the correct calibraion values>*/
#    define EVDEV_VER_MIN      3900
